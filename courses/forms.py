...
class SubjectForm(forms.ModelForm):
    class Meta:
        model = Subject
        fields = ['creator', 'slug', 'title', 'class_obj', 'description', 'image']
        help_texts = {
            'title': 'Ex. Mathematics, Geography etc.',
            'description': 'Put a brief description of the subject',
            'class_obj': 'Choose the class for which you will create the subject',
            'image': 'You can put a photo of the subject or it can be left blank'
        }
        labels = {
...
class LessonForm(forms.ModelForm):
    class Meta:
        ...
        help_texts = {
            ...
            'video_id': 'Enter the ID of the video from Youtube which you will upload (<a '
                        'href="/media/youtube_help.png">where can i find the ID</a>)',
